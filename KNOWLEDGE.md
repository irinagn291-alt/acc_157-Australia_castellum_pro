...
**Desk `maidenhead_path` — Ham path + gray line**
- Home: Azimuthal map + QSL.
- Invariant (unit-test this): Maidenhead 2–8; haversine; long path; terminator from solar declination.
- Fake that fails: Callsign table.
